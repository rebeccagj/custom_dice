...
*/
/* przetestowany zakres poprawnej generacji
d4 - 1 - 7568
d6 - 1.1 - 4345
d8 - 1 - 5214
...
*/
//use <font.tff>
font1 = "Courier New Bold";
dicesize = 16; 

//wspolczynniki wielkosci kostek
d4size = 1.125*dicesize*1.224956; //korekcja wynikajaca z punktow wieloscianu
d6size = dicesize;
d8size = dicesize;
d10size = dicesize;
d00size = dicesize;
...
//glebokosc cyfr, okreslona jako % wysokosci kostki
d4textdepth = 2.5;
d6textdepth = 2.5;
d8textdepth = 2.5;
d10textdepth = 2.5;
...
//mnoznik wielkosci tekstu jako % wysokosci kostki
d4textsize = 25;
d6textsize = 60;
d8textsize = 50;
d10textsize = 40;
...
//odsuniecie cyfr od srodka kosci jako % wysokosci kosci
d4textpush = 24;
d10textpush = 15;

//odsuniecie podkreslnika
d10underpush6 = 25;
d10underpush9 = 30;
d00underpush6 = 25;
d00underpush9 = 35;
...
underscore=[" ", " ", " ", " ", " ", "_", " ", " ","_", " ", " ", " ", " ", " ", " "," ", " ", " ", " ", " "];        //underscore d20
otext=["1", "2", "3", "15", "19", "6", "7", "8","9", "10", "12", "4", "20", "5", "14","11", "18", "17", "13", "16"];  //text d20
